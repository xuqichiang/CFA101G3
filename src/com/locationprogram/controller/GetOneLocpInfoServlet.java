...
@WebServlet("/locationprogram/getOneLocpInfoServlet")
public class GetOneLocpInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("locp_smem_id", locpVO.getLocp_smem_id());
		map.put("locp_content", locpVO.getLocp_content());
		map.put("locp_status", locpVO.getLocp_status());
		if(locpiVO != null) {
			map.put("locpi_images", locpiVO.getLocpi_images());
		}
