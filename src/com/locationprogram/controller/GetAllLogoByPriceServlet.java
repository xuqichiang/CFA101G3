...
@WebServlet("/locationprogram/getAllLogoByPriceServlet")
public class GetAllLogoByPriceServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("hightolow".equals(condition)) {
			...
			list = locpsvc.getAllLogoHighToLow();
		...
		if("lowtohigh".equals(condition)) {
			...
			LocpService locpsvc = new LocpService();
			list = locpsvc.getAllLogoLowToHigh();
