...
public class SendEmail extends Thread{
	...
	public void run() {
	      ...
	      try {
	         ...
	         //信件內容以HTML格式傳出去
	         message.setContent("<h1>請點擊下列連結啟用您的帳號</h1><br><a href=\"http://35.229.219.175:8080/CFA101G3/member/activeServlet?username="+email+"&code="+code+"\">點擊後啟用您的帳號</a>","text/html; charset=UTF-8" );
