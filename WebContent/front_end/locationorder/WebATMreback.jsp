...
<%
	Integer loco_DEPOSIT = (Integer)request.getAttribute("loco_DEPOSIT");
	if(loco_DEPOSIT == null){
...
<body>
    ...
    <div id="wrap">
        ...
        <form action="<%=request.getContextPath()%>/locationorder/GetorderLocrServletfront" method="post" id="submit-form">
            <input type="hidden" name="action" value="webATMreback">
            <input type="hidden" name="pay" id="pay">
			<input type="hidden" name="loco_DEPOSIT" id="loco_DEPOSIT">
        </form>
    </div>
    <script>
