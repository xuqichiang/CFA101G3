...
<%
	Object loco_DEPOSIT = request.getAttribute("loco_DEPOSIT");
...
<body>
    ...
    <div class="form-container">
        <form action="<%=request.getContextPath()%>/locationorder/GetorderLocrServletfront" id="submit-form" method="post">
            ...
            <input type="hidden" name="action" value="creditcardreback">
        </form>
    </div>
